      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-16 w-full py-20 mt-10">
        ...
        >
          ...
          <motion.div
            ...
            className="flex items-center gap-2 px-4 py-1.5 rounded-full border border-blue-500/30 bg-blue-950/40 mb-6"
          >
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl md:text-6xl lg:text-5xl font-extrabold leading-tight mb-6 uppercase"
          >
          ...
          >
            ...
            {/* <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-3.5 rounded-full font-semibold text-base sm:text-lg bg-transparent border-2 border-[#0077FF] text-[#0077FF] hover:bg-[#0077FF] hover:text-white transition-all flex items-center justify-center"
            >
              View Our Work
            </motion.a> */}
          </motion.div>
          ...
          >
            ...
            >
              ...
              <span className="text-xs sm:text-sm text-gray-300 font-medium tracking-wider mt-1">YEARS EXP</span>
            </motion.div>

            <div className="w-px h-15 bg-white/20"></div>
            ...
            <motion.div
              ...
              className="flex flex-col items-center sm:items-start"
            >
              <span className="text-3xl sm:text-4xl font-extrabold text-white">1000+</span>
              <span className="text-xs sm:text-sm text-gray-300 font-medium tracking-wider mt-1">PROJECTS</span>
            </motion.div>
            ...
            >
              ...
              <span className="text-xs sm:text-sm text-gray-300 font-medium tracking-wider mt-1">QUALITY</span>
            </motion.div>
          ...
          <motion.div
            className="flex flex-col items-center sm:hidden mt-4 pt-4 border-t border-white/20 w-full"
            variants={{ hidden: { opacity: 0 }, show: { opacity: 1, transition: { delay: 0.6 } } }}
          >
            <span className="text-3xl font-extrabold text-white">100%</span>
            <span className="text-xs text-gray-300 font-medium tracking-wider mt-1">QUALITY</span>
          </motion.div>
